 ...
 */
export default function canonicalUrl(props: Props, req: Request, ctx: Context): string {
    const { removeAllParams = false, forceHttps = true, removeTrailingSlash = true, } = props;
