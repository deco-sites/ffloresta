...
function ProductCard({
  ...
  if (isMobile) {
    return (
      <div class="bg-white flex p-2 w-full border-solid border-[0.7px] border-[#8D98A0] font-['FS_Emeric']">
        {/* Imagem à esquerda */}
  ...
  // Versão desktop
  return (
    <div class="bg-white flex flex-col p-[12px_18px] w-full max-w-[258px] border-solid border-[0.7px] border-[#8D98A0] font-['FS_Emeric']">
