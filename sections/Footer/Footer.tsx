        ...
        <div class="w-full bg-[#3A4332]">
          <div class="container flex flex-col w-full lg:pt-[72px] lg:pb-10">
            ...
            {!isMobile
              ...
              : (
                ...
                <div class="flex flex-col gap-4 pt-6">
                  ...
                  {securitySeals && (
                    <div class="flex flex-col">
                      <SectionTitle title="Loja Segura" />
                      {/* Selos de Segurança - Lista de Imagens */}
            ...
            <div class="flex flex-col gap-6 items-center justify-between mt-[30px] lg:mt-16">
              ...
              <div class="pb-5 lg:pb-0 flex flex-nowrap items-center justify-between sm:justify-center gap-4">
                <span class="text-xs font-normal text-center lg:text-start text-white">
                  {trademark}
                </span>
              </div>
            </div>
...
const AccordionItem = ({
  ...
  <details class={`group ${className}`}>
    <summary class="font-normal text-[16px] text-white cursor-pointer flex justify-between items-center min-h-[48px] list-none border-b border-[#4A5A3F] py-2">
      <span>{title}</span>
      <svg
        width="12"
        height="7"
    ...
    <div class="pt-3 pb-4">{children}</div>
  </details>
);
