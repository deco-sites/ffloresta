          ...
          <div class="flex flex-col lg:flex-row gap-x-[20px]">
            {device === "mobile" ? (
              <div class="flex flex-col gap-y-[10px]">
                <p class="text-[#273D28] text-[14px]">{lojas.lojas[0].title}</p>
                ...
                <div class="flex flex-row flex-wrap">
                  <p class="text-[#273D28] text-[12px] font-bold">TELEFONE:</p>
                  <p class="text-[#273D28] text-[12px]">{lojas.lojas[0].tel}</p>
                </div>
                <div>
                  <p class="text-[#273D28] text-[12px] font-bold underline decoration-[#273D28]">
