...
const ButtonSizesPreview = () => {
  ...
  return (
    <div class="bg-white overflow-x-auto rounded-lg flex flex-col p-2 gap-2">
...
const ButtonStylesPreview = () => {
  ...
  return (
    <div class="bg-white overflow-x-auto rounded-lg flex flex-row p-2 gap-2">
...
const TextColorsPreview = () => {
  ...
  return (
    <div class="bg-white overflow-x-auto rounded-lg flex flex-row p-2 gap-2 text-sm md:text-base">
