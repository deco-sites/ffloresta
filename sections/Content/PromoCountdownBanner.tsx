...
export default function PromoCountdownSection({ image, countdownDate, title, promoName, }: SectionProps<typeof loader>) {
    return (<div class="w-full container mx-auto">
      <ProductPagePromoBannerIsland image={image} countdownDate={countdownDate} title={title} promoName={promoName}/>
    </div>);
}
