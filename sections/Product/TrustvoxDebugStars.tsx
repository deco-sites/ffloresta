    ...
    return (
      <div class="p-4 bg-yellow-100 border border-yellow-400 rounded">
        <h3 class="font-bold text-lg mb-2">
          Debug Trustvox Stars - Nenhum produto fornecido
        </h3>
      </div>
    );
  }
  ...
  return (
    <div class="p-4 bg-blue-100 border border-blue-400 rounded mb-4">
      ...
      <div class="mb-4">
        ...
        <p>
          <strong>vtexProductId (inProductGroupWithID):</strong>{" "}
          {vtexProductId || "❌ Não encontrado"}
        </p>
        <p>
          <strong>RefId:</strong> {refId || "❌ Não encontrado"}
        </p>
        <p>
          <strong>SKU:</strong> {sku || "❌ Não encontrado"}
        </p>
        <p>
          <strong>productID:</strong> {productIdFallback || "❌ Não encontrado"}
        </p>
        <p>
          <strong>ID Final Usado:</strong>{" "}
          {finalProductId || "❌ Nenhum ID disponível"}
        </p>
      </div>
        ...
        {finalProductId
          ...
          : (
            <p class="text-red-600">
              ❌ Nenhum ID válido encontrado - Estrelas não podem ser exibidas
            </p>
          )}
      </div>
