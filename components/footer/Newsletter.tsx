...
function Newsletter() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const policies = politicaInput.checked ? "true" : "false";

      const res = await invoke.vtex.actions.masterdata.createDocument({
        data: { emaill, name, policies },
        acronym: "NL",
      });
              ...
              <div class="space-y-4">
                ...
                >
                  ...
                  <p class="text-[12px] text-white">
                    ...
                    PRIVACIDADE E PODERÁ ALTERAR OU CANCELAR A NEWSLETTER A
                    QUALQUER MOMENTO QUE VOCÊ DESEJAR. AQUI VOCÊ ECONOMIZA NAS
                    SUAS COMPRAS E NÃO RECEBE SPAM
                  </p>
                </label>
              </div>
            </div>
