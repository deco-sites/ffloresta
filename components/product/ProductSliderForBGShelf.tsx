      ...
      <div id={id} class="relative container mx-auto px-4 lg:px-[48px]">
        ...
        >
          {products.map((product, index) => (
            <Slider.Item
              index={index}
              class="snap-start flex-shrink-0 min-h-[460px] max-[450px]:min-h-[430px]  max-[768px]:w-[calc(50%-10px)] max-[1024px]:w-[calc(33.3%-10px)] max-[1240px]:w-[calc(25%-20px)] w-[calc(20%-21px)]"
            >
              <ProductCard
                index={index}
                product={product}
