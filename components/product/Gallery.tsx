  ...
  return (
    <>
      ...
      >
        ...
        <div class="relative h-min flex-grow group">
          {/* Desktop Arrows */}
          <div class="hidden sm:flex absolute z-10 w-full h-full pointer-events-none">
            <div class="flex items-center justify-between w-full h-full px-2">
              <Slider.PrevButton
                class="pointer-events-auto w-[20px] h-[20px] bg-transparent rounded-full p-2"
